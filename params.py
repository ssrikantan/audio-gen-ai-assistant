...
aoai_base_url = "https://xxxxxxxxx1.openai.azure.com/"  # Base URL for the Azure OpenAI Service
aoai_key = "xxxxxxxxxxxxxxxxxxxx"  # Subscription key for the Azure OpenAI Service
...
ai_search_url = "https://xxxxxxxxxxx.search.windows.net"  # Base URL for the Azure Cognitive Search service
